...
Qubits between Alice and Bob with purpose_id 4:
  27865510: [Qubit('QS#10688-0'), Qubit('QS#10686-0')] with create_id 3
...
class HeraldedConnection(Connection):
    ...
    def __init__(self, name, length_to_a, length_to_b, time_window=0):
        ...
        qchannel_a = QuantumChannel("QChannelA", delay=delay_a, models={"quantum_loss_model": FibreLossModel(p_loss_init=0, p_loss_length=0.8, rng=None)})
        qchannel_b = QuantumChannel("QChannelB", delay=delay_b, models={"quantum_loss_model": FibreLossModel(p_loss_init=0, p_loss_length=0.8, rng=None)})
